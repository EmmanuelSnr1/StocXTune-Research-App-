...
# from watchlists_api.models import Stock, UserWatchlist,WatchlistStocks
# from django.contrib.auth.models import User


# class UserWatchlistsTests(APITestCase):
...
#         root = reverse(('watchlists_api:detailcreate'), kwargs={'pk': 1})
#         response = self.client.get(url, format='json')
#         self.assertEqual(response.status_code, status.HTTP_200_OK)