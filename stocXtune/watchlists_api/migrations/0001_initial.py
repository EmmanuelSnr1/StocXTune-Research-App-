# Generated by Django 4.0.3 on 2022-05-15 08:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ticker', models.CharField(max_length=10)),
                ('watchlistid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='watchlists_api.userwatchlist')),
            ],
        ),
    ]
